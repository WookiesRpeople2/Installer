...
pub const SWAP_T_INTRO_MODE: &str = "Select swap option";
pub const SWAP_T_INTRO_DISK: &str = "Select disk to wipe for swap";
pub const SWAP_T_INTRO_SIZE: &str = "Swap size in GB";
pub const SWAP_T_FOOTER_MODE: &str = "Create options wipe the chosen disk layout";
pub const SWAP_T_FOOTER_DISK: &str = "WARNING: entire disk will be used for swap";
pub const SWAP_T_FOOTER_SIZE: &str = "Enter a whole number · Shift-Tab back";
pub const SWAP_ON_INSTALL: &str = "Create on main disk";
pub const SWAP_NONE: &str = "None";
pub const SMGR_P_SWAP_SIZE_KEY: &str = "Size (GB)";
pub const SMGR_P_SWAP_SIZE_VALUE: &str = "4";
pub const SMGR_P_SWAP_SIZE_MAX: usize = 4;
pub const SMGR_S_SWAP_DISK_KEY: &str = "Swap Disks";
pub const SWAP_CREATE_OTHER: &str = "Create on another disk";
